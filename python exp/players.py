...
class NetworkPlayer(Player):
    ...
    def __init__(self, net, action_fn, update_fn, reward_length=1, history_coeff=0.5, save_iter=1, weights_path='weights', experiment_name='test'):
    ...
    def onGameEnd(self, cur_game_idx):
        ...
        if cur_game_idx % self.save_iter == 0:
