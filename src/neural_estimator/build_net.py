...
def BuildGraphNetwork(adjustment_matrix, features, filter_mask, num_features):
    ...
    net['cell3'] = GraphConvCell(net['cell2'], net['adjustment_matrix'], 32, net['nonlinearity'])
    net['cell4'] = GraphConvCell(net['cell3'], net['adjustment_matrix'], 32, net['nonlinearity'])
    ...
    net['cell5'] = GraphConvCell(net['dropped'], net['dropped_matrix'], 64, net['nonlinearity'])
    net['cell6'] = GraphConvCell(net['cell5'], net['dropped_matrix'], 64, net['nonlinearity'])
    net['cell7'] = GraphConvCell(net['cell6'], net['dropped_matrix'], 64, net['nonlinearity'])
    net['cell8'] = GraphConvCell(net['cell7'], net['dropped_matrix'], 64, net['nonlinearity'])
