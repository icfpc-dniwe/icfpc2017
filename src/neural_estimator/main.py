...
def prep():
    ...
    #            net_player('_newman1', 1, 0.9, net2, a2, None, save_iter=100000)]
    ...
    #            net_player('_newman2', 1, 0.9, net2, a2, None, save_iter=100000)]
    ...
    LoadNet(net3['desc'], 'weights/test_middle_newman00_99.npz')
